...
<body>
    ...
    <a href="querystring?name=은아&age=39&birthday=2025-05-30&gender=F&national=etc&hobbies=movie&hobbies=music">쿼리스트링을
        이용한 값 전달</a>
    ...
    <form action="formdata" method="post">
        ...
        <br>
        <label>성별 : </label>
        <input type="radio" name="gender" id="male" 2 value="M"><label for="male2">남자</label>
        ...
        <br>
        <label>취미 : </label>
        <input type="checkbox" name="hobbies" id="movie2" value="movie"><label
            for="movie2">영화</label>
        <input type="checkbox" name="hobbies" id="music2" value="music"><label
            for="music2">음악</label>
        <input type="checkbox" name="hobbies" id="sleep2" value="sleep"><label
            for="sleep2">취침</label>
        <br>
